      ...
      <div className="flex h-screen items-center justify-center bg-gray-100">
          <div className="bg-indigo-100 p-6 rounded shadow-md w-96">
              ...
              <button
                  ...
                  disabled={loading}
                  className={`w-full mx-auto ${loading ? "bg-gray-400" : "bg-gradient-to-r from-blue-950 to-indigo-950"} text-white px-14 py-3 rounded-lg hover:bg-indigo-500 transition-transform duration-200 transform hover:scale-105 cursor-pointer`}
              >
